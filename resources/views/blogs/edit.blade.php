        ...
        <form id="form" name="formA" class="justify-center m-10 md:flex text-blue-200 text-center" >
            ...
            <div class="shadow-lg justify-center content-center">
                <div class="form p-4 bg-gray-500 ring-1 ring-black p-2">
                    <div class="">
                        <strong>Názov:</strong>
                        <input id="title" type="text" name="title" class="text-black" placeholder="Názov" value="{{ $blog->title }}">
                    </div>
                ...
                <div class="form p-4 bg-gray-500 ring-1 ring-black p-2">
                    <div class="">
                        <strong>Popis:</strong>
                        <input id="popis" type="text" name="popis" class="text-black" placeholder="Popis" value="{{ $blog->popis }}">
                    </div>
                    <small class="invisible absolute">Error</small>
                </div>
                <div class="form p-4 bg-gray-500 ring-1 ring-black p-2">
                    <div class="">
                        <strong>Text:</strong>
                        <textarea class="text-black" name="text" id="form" cols="30" rows="10" placeholder="Text" >{{ $blog->text }}</textarea>
                    </div>
                    <small class="invisible absolute">Error</small>
                </div>
                ...
                <div class=" bg-gray-500 ring-1 ring-black p-2">
                    <button id="btn" class="bg-gray-600 hover:bg-gray-800 text-white font-bold py-2 px-4 border-b-4 border-gray-600 hover:border-gray-800 rounded">Uprav</button>
                </div>
            </div>
        </form>
